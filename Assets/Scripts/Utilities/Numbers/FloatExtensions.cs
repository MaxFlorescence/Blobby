...
public static class FloatExtensions
{
    ...
    ///     <tt>epsilon</tt>).
    /// </returns>
    public static bool Approx(this float actual, float? expected, float epsilon = EPSILON)
    {
    ...
    /// </returns>
    public static int? RoundIfClose(this float number, float epsilon = EPSILON)
    {
