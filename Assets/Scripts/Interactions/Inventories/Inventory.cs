...
public class Inventory : MonoBehaviour
{
    ...
    {
        addAudioClip = Resources.Load<AudioClip>(Files.SOUNDS_PATH + addSoundResource);
        removeAudioClip = Resources.Load<AudioClip>(Files.SOUNDS_PATH + removeSoundResource);
