...
public class Chest : Grip
{
    ...
    protected override void Start()
    {
        ...
        chestOpen = Resources.Load<AudioClip>(Files.SOUNDS_PATH + CHEST_OPEN_SOUND);
        chestClose = Resources.Load<AudioClip>(Files.SOUNDS_PATH + CHEST_CLOSE_SOUND);
        chestLoot = Resources.Load<AudioClip>(Files.SOUNDS_PATH + CHEST_LOOT_SOUND);
