...
class DungeonLayoutGenerator
{
    ...
    public DungeonTile GetTile(int index = -1, Vector3Int? position = null)
    {
        ...
        if (fromFile)
        {
            if (index.OutOfBounds(0, tileCount-1)) {
                ...
                index = ((Vector3Int)position).ToFlatIndex(layoutDimensions.x, layoutDimensions.y);
            }
        ...
        else
        {
            if (IsInvalid(position)) {
                ...
                position = index.To3DIndex(layoutDimensions.x, layoutDimensions.y);
            }
    ...
    private bool IsInvalid(Vector3Int? position)
    {
        ...
        return positionNonNull.OutOfBounds(layoutDimensions - Vector3Int.one);
    }
