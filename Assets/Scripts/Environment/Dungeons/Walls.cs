...
public static class WallsExtensions
{
    ...
    private static readonly Dictionary<Walls, (DungeonTileType, Quaternion)> wallsToTile = new()
    {
        ...
        {Walls.Junction_Forward,     (DungeonTileType.Junction,    Rotation.Forward)},
        {Walls.Junction_Right,       (DungeonTileType.Junction,    Rotation.Right)},
        {Walls.Junction_Back,        (DungeonTileType.Junction,    Rotation.Back)},
        {Walls.Junction_Left,        (DungeonTileType.Junction,    Rotation.Left)},
        {Walls.Hallway_Forward_Back, (DungeonTileType.Hallway,     Rotation.Forward)},
        {Walls.Hallway_Right_Left,   (DungeonTileType.Hallway,     Rotation.Right)},
        {Walls.Corner_Left_Forward,  (DungeonTileType.Corner,      Rotation.Forward)},
        {Walls.Corner_Forward_Right, (DungeonTileType.Corner,      Rotation.Right)},
        {Walls.Corner_Right_Back,    (DungeonTileType.Corner,      Rotation.Back)},
        {Walls.Corner_Back_Left,     (DungeonTileType.Corner,      Rotation.Left)},
        {Walls.Dead_End_Forward,     (DungeonTileType.Dead_End,    Rotation.Forward)},
        {Walls.Dead_End_Right,       (DungeonTileType.Dead_End,    Rotation.Right)},
        {Walls.Dead_End_Back,        (DungeonTileType.Dead_End,    Rotation.Back)},
        {Walls.Dead_End_Left,        (DungeonTileType.Dead_End,    Rotation.Left)},
        {Walls.Stairs_Up_Forward,    (DungeonTileType.Stairs_Up,   Rotation.Forward)},
        {Walls.Stairs_Up_Right,      (DungeonTileType.Stairs_Up,   Rotation.Right)},
        {Walls.Stairs_Up_Back,       (DungeonTileType.Stairs_Up,   Rotation.Back)},
        {Walls.Stairs_Up_Left,       (DungeonTileType.Stairs_Up,   Rotation.Left)},
        {Walls.Stairs_Down_Forward,  (DungeonTileType.Stairs_Down, Rotation.Forward)},
        {Walls.Stairs_Down_Right,    (DungeonTileType.Stairs_Down, Rotation.Right)},
        {Walls.Stairs_Down_Back,     (DungeonTileType.Stairs_Down, Rotation.Back)},
        {Walls.Stairs_Down_Left,     (DungeonTileType.Stairs_Down, Rotation.Left)}
    };
